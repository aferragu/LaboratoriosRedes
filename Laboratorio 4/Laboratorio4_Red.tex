...
\item En el caso de \textbf{GNS3}, luego de importar el projecto portable, aparecen toda la topología ya conectada, incluyendo Routers y PC virtuales. En este caso se debe:
 \begin{enumerate}[label=\arabic*.]
    \item Iniciar la simulación los equipos (ícono de Play).
